...
2. Версія 0.2.0 – ті ж функції, але з базовими типами
...
3. Версія 0.3.0 – нова функція зі складним типом
...
4. Версія 0.4.0 – інтерфейси + generics
...
5. Версія 0.5.0 – клас `Logger` + змінені оточення (`.env`)
...
6. Версія 1.0.0 – стабілізація публічного `API` + посилення правил
...
7. Версія 2.0.0 – `breaking change`: зміна сигнатури `add`
